...
const Homepage: React.FC<Props> = ({ homepage, about_block, featured_courses, testimonials }) => {
  return (
    <div>
      <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const res = await fetch("https://next-workshop-backend-01.herokuapp.com/homepage");
  ...
  const resCourses = await fetch("https://next-workshop-backend-01.herokuapp.com/courses?_start=1&_limit=3");
  const featured_courses = await resCourses.json();

  const resTestimonials = await fetch("https://next-workshop-backend-01.herokuapp.com/testimonials");
